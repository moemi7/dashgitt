...
const LoginModal = () => {
  ...
  const footerContent = (
    <div className="mt-3 flex flex-col gap-4">
      <div className="h-px w-full bg-[#DFE3FA] dark:bg-[#252945]"></div>
      <Button
        disabled={isLoading}
        grey
      ...
      <div className="mt-4 text-center font-light text-neutral-500">
        <div className="text-darkGrey flex flex-row items-center justify-center gap-2 text-xs font-medium leading-5">
